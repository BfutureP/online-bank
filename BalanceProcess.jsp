...
try{ 
	 ...
	 Class.forName("com.mysql.jdbc.Driver");
	    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/bankiin","root","password");
	   	    ...
	   	    String sql="select * from register_ac where acno = '" +acno+ "' " ;
...
<h2 align="center"><font><strong>Your current balance</strong></font></h2>
...
<% out.println("<tr><td>");
out.println(rs.getString(1) + "</td><td>" + rs.getString(3) + "</td><td>" + rs.getString(4) + "</td><td>" + rs.getString(7) + "</td></tr>");
	    }
